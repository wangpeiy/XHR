    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <UploadImg ref="uploadPic" :default-url="employeesPic" @on-success="uploadPicSuccess" />
        </el-form-item>
...
import { getUserDetailByIdAPI, getPersonalDetailAPI, savePersonalDetailAPI, saveUserDetailByIdAPI } from '@/api'
...
export default {
  ...
  methods: {
    async getUserDetailById() {
      ...
      // 判断用户信息中是否有头像,如果有就将头像信息传入UploadImg组件中
      if (res.staffPhoto) {
    ...
    async savePersonalDetail() {
      try {
        ...
        await savePersonalDetailAPI(this.formData)
