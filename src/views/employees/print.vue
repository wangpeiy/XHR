...
<script>
import { getPersonalDetailAPI as getPersonalDetail, getJobDetailAPI as getJobDetail } from '@/api/employees'
import { getUserDetailByIdAPI as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
